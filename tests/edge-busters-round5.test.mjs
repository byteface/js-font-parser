...
test('round5 edge: LayoutEngine should not throw if getGlyphIndexByChar throws for one char', () => {
  const font = {
    getTableByType() { return null; },
...
test('round5 edge: LayoutEngine should not throw if kerning callback throws', () => {
  const font = {
    getTableByType() { return null; },
...
test('round5 edge: LayoutEngine should still return finite result with throwing kerning callback', () => {
  const font = {
    getTableByType() { return null; },
    getGlyphIndexByChar() { return 1; },
    getGlyph() { return { advanceWidth: 500 }; },
