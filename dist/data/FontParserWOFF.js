            ...
            if (this.gvar && this.variationCoords.length > 0) {
                ...
                if (deltas) {
                    ...
                    for (var p = 0; p < basePointCount; p++) {
                        ...
                        var ox = compIndex >= 0 && compDx ? (_h = compDx[compIndex]) !== null && _h !== void 0 ? _h : 0 : 0;
                        var oy = compIndex >= 0 && compDy ? (_j = compDy[compIndex]) !== null && _j !== void 0 ? _j : 0 : 0;
                        var x = base_1.getXCoordinate(p) + ((_k = dx_1[p]) !== null && _k !== void 0 ? _k : 0) + ox;
                        var y = base_1.getYCoordinate(p) + ((_l = dy_1[p]) !== null && _l !== void 0 ? _l : 0) + oy;
                        if (x < minX)
                            minX = x;
                        if (x > maxX)
                            maxX = x;
