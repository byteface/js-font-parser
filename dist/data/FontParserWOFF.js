...
var FontParserWOFF = /** @class */ (function () {
    ...
    FontParserWOFF.prototype.getGlyph = function (i) {
                ...
                if (deltas) {
                    ...
                    if (!isComposite_1) {
                        ...
                        for (var c = 0; c < componentCount; c++) {
                            var rawDx = (_j = fullDx[c]) !== null && _j !== void 0 ? _j : 0;
                            var rawDy = (_k = fullDy[c]) !== null && _k !== void 0 ? _k : 0;
                            compDx_1[c] = rawDx;
                            compDy_1[c] = rawDy;
                        }
                        ...
                        for (var c = 0; c < componentCount; c++) {
                            ...
                            if (comp.hasTwoByTwo()) {
                                var idx1 = tIndex++;
                                var idx2 = tIndex++;
                                compXScale_1[c] = ((_l = fullDx[idx1]) !== null && _l !== void 0 ? _l : 0) / 0x4000;
                                compScale01_1[c] = ((_m = fullDy[idx1]) !== null && _m !== void 0 ? _m : 0) / 0x4000;
                                compScale10_1[c] = ((_o = fullDx[idx2]) !== null && _o !== void 0 ? _o : 0) / 0x4000;
                                compYScale_1[c] = ((_p = fullDy[idx2]) !== null && _p !== void 0 ? _p : 0) / 0x4000;
                            }
                            else if (comp.hasXYScale()) {
                                var idx = tIndex++;
                                compXScale_1[c] = ((_q = fullDx[idx]) !== null && _q !== void 0 ? _q : 0) / 0x4000;
                                compYScale_1[c] = ((_r = fullDy[idx]) !== null && _r !== void 0 ? _r : 0) / 0x4000;
                            }
                            else if (comp.hasScale()) {
                                var idx = tIndex++;
                                var delta = ((_s = fullDx[idx]) !== null && _s !== void 0 ? _s : 0) / 0x4000;
                    ...
                    var lsbDelta = (_t = fullDx[phantomBase]) !== null && _t !== void 0 ? _t : 0;
                    var rsbDelta = (_u = fullDx[phantomBase + 1]) !== null && _u !== void 0 ? _u : 0;
                    lsb += lsbDelta;
                    ...
                    for (var p = 0; p < basePointCount; p++) {
                        ...
                        if (comp && compIndex >= 0 && self_1.glyf) {
                            ...
                            var ox = compIndex >= 0 && compDx_1 ? (_1 = compDx_1[compIndex]) !== null && _1 !== void 0 ? _1 : 0 : 0;
                            var oy = compIndex >= 0 && compDy_1 ? (_2 = compDy_1[compIndex]) !== null && _2 !== void 0 ? _2 : 0 : 0;
                            x = base_1.getXCoordinate(p) + ((_3 = dx_1[p]) !== null && _3 !== void 0 ? _3 : 0) + ox;
                            y = base_1.getYCoordinate(p) + ((_4 = dy_1[p]) !== null && _4 !== void 0 ? _4 : 0) + oy;
                        }
                        if (x < minX_1)
                            minX_1 = x;
                        if (x > maxX_1)
        ...
        if (this.cff) {
            ...
            if (cffDesc) {
                var glyphData = new GlyphData(cffDesc, (_6 = (_5 = this.hmtx) === null || _5 === void 0 ? void 0 : _5.getLeftSideBearing(i)) !== null && _6 !== void 0 ? _6 : 0, (_8 = (_7 = this.hmtx) === null || _7 === void 0 ? void 0 : _7.getAdvanceWidth(i)) !== null && _8 !== void 0 ? _8 : 0, { isCubic: true });
                this.glyphCache.set(cacheKey, glyphData);
                return glyphData;
            }
        }
    ...
    FontParserWOFF.prototype.createEmptyGlyphData = function (i) {
        var _a, _b;
