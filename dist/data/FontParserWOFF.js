                ...
                if (deltas) {
                    ...
                    for (var p = 0; p < basePointCount; p++) {
                        ...
                        if (comp && compIndex >= 0 && _this.glyf) {
                            ...
                            var ox = compIndex >= 0 && compDx ? (_p = compDx[compIndex]) !== null && _p !== void 0 ? _p : 0 : 0;
                            var oy = compIndex >= 0 && compDy ? (_q = compDy[compIndex]) !== null && _q !== void 0 ? _q : 0 : 0;
                            x = base_1.getXCoordinate(p) + ((_r = dx_1[p]) !== null && _r !== void 0 ? _r : 0) + ox;
                            y = base_1.getYCoordinate(p) + ((_s = dy_1[p]) !== null && _s !== void 0 ? _s : 0) + oy;
                        }
                        if (x < minX)
                            minX = x;
                        if (x > maxX)
