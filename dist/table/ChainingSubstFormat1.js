    ...
    applyToGlyphsWithContext(glyphs, ctx) {
        ...
        while (i < out.length) {
            ...
            for (const rule of rules) {
                if (!matchBacktrackSequence(out, i, rule.backtrack, (expected, gid) => gid === expected, ctx))
                    continue;
                ...
                if (!matchLookaheadSequence(out, lookStart, rule.lookahead, (expected, gid) => gid === expected, ctx))
                    continue;
