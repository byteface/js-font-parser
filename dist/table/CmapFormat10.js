var CmapFormat10 = /** @class */ (function () {
    function CmapFormat10(byteArray) {
    ...
    CmapFormat10.prototype.getFormatType = function () {
        return this.format; // Return the format type
    };
    CmapFormat10.prototype.getGlyphIndex = function (charCode) {
