...
export function supportsLanguage(font: { getGlyphIndexByChar: (ch: string) => number | null }, code: string): LanguageCheckResult | null {
...
export function getSupportedLanguages(font: { getGlyphIndexByChar: (ch: string) => number | null }): LanguageCheckResult[] {
